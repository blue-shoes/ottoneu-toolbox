...
def resolve_draft_results_against_rosters(league:League, value_calc:ValueCalculation, last_time:datetime, inf_method:InflationMethod, demo_source:bool=False) -> Tuple[List[Player], List[Player], datetime]:
