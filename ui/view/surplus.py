...
class Surplus(tk.Frame):
    ...
    def __create_view(self):
        ...
        self.player_table = ScrollableTreeFrame(
            self, cols, pack=False, sortable_columns=cols, reverse_col_sort=rev_cols, column_widths=widths, init_sort_col='Surplus', column_alignments=align, checkbox=date_util.is_offseason()
        )
