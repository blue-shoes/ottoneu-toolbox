...
class Scrape_Davenport(scrape_base.Scrape_Base):
    ...
    def get_projections(self) -> Tuple[DataFrame, DataFrame]:
        ...
        pos_df = self.__get_dataset(
            lookup_url='https://claydavenport.com/projections/hitter_projections.txt', csv_url='https://claydavenport.com/projections/clayhitters.csv', lookup_col=['IDNO', 'MLBID']
        )
        pitch_df = self.__get_dataset(
            lookup_url='https://claydavenport.com/projections/pitcher_projections.txt', csv_url='https://claydavenport.com/projections/claypitchers.csv', lookup_col=['HOWEID', 'BPID']
        )
